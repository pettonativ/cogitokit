...
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| **Agents/Workflows/Skills Usage Plan** | List of used items and missing items check against `https://skills.sh/` catalog (MANDATORY if cogitokit exists) |
| **Overview**                           | What & why                                                                                                     |
...
| -------------------------------------- | ------------------------------------------------------------------------------ | ----------------------- |
| **Agents/Workflows/Skills Usage Plan** | List of tools to use & missing tool check against `https://skills.sh/` catalog | Mandatory for cogitokit  |
